    ...
    if (!navigator.mediaDevices || !navigator.mediaDevices.enumerateDevices) {
        ...
        .then(function(devices) {
          devices.forEach(function(device) {
            ...
            document.getElementById("mic-sel").innerHTML += 
...
var selectedValue = document.getElementById("mic-sel").value;

    console.log(selectedValue)
    console.log(document.getElementById("mic-sel").defaultValue)

    async function mic() {
        
        console.log(minput)
        var constraints = { audio: true, deviceId: { exact: minput } };
    ...
    function visualize(from, source) {
        ...
        function myMethod( )
{   
    exampleSocket.send(utfEncode(dataArray))//JSON.stringify(dataArray))
